...
//    log(LOG_MARK, e.message.toString())
  }
}
...
//    log("Exception-yxm", "exception my method: ${e.printStackTrace()}")
  }
}
...
//    log("Exception-yxm-T", "exception my method: ${e.printStackTrace()}")
    null
  }
...
//// RxJava 工作线程延时一定时间切换到UI线程，避免重复执行
//var disposable: Disposable? = null
//inline fun rxUi(scopeProvider: ScopeProvider, delay: Long? = 0L, crossinline action: () -> Unit): Disposable?{
//  disposable = io.reactivex.Observable.timer(delay!!, TimeUnit.MILLISECONDS)
